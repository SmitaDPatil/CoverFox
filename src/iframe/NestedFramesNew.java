...
public class NestedFramesNew {
	...
	
	{
		...
		driver.switchTo().frame("frame1");//switching selenium focus from main page to frame1(outer frame)
		
		
		//writing on in text box present in outer frame
		...
		Thread.sleep(1000);driver.findElement(By.id("a")).click();
